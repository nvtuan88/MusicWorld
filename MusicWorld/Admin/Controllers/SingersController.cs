...
namespace Admin.Controllers
{
    public class SingersController : Controller
    {
        ...
        public SingersController(StoreDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,SingerName,SingerImg,DescriptionSinger")] Singer singer)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SingerName,SingerImg,DescriptionSinger")] Singer singer)
        {
            if (id != singer.Id)
            {
                return NotFound();
